...
export default {
    ...
    data() {
        return {
            ...
            valueSelect: "",
            data2: [{label: "Options1", value: "1"}, {label: "Options2", value: "2"}, {label: "Options3", value: "3"}],
            valueSelect2: "2",
            data3: {value1: "Option1", value2: "Option2"},
            valueSelect3: "",
            data4: { value1: { title: "Option 1", id: "1" }, value2: { title: "Option 2", id: "2" } },
            valueSelect4: "",
        }
    },
    methods: {
